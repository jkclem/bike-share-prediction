...
# Comparison  
```{r}
lmPred <- predict(lmfit1a,  newdata=bikedayTest1)
lmTest <- postResample(lmPred , bikedayTest1$casual)
lmTest 
boostPred <- predict (gbmFit, newdata=select (bikedayTest1, - casual ), n.trees=1000)
boostTest <- postResample(boostPred, bikedayTest1$casual)
boostTest
...
apply(reports, MARGIN=1, 
    FUN=function(x){
                    render(input="../project/bike-share-prediction.Rmd",
