...
$$\text{# of rentals}_i \overset{iid}\sim \text{N}(\mu_i = \beta_0 + \Sigma_{j=1}^{10}\beta_ix_i, \text{ } \sigma^2)$$
...
$$\text{# of rentals}_i \overset{iid}\sim \text{Poisson}(\lambda_i = \beta_0 + \Sigma_{j=1}^{10}\beta_ix_i)$$
