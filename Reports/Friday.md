...
Friday) will act as the response, which makes more sense for bike rental
...
-   read in the data and subset for Fridays and split into training and
    testings sets
...
and subset for all the Fridays in the data set.
...
rentals in a day for all the Fridays in the data to get an idea of the
distribution.
...
![](./Reports/Friday_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
|:-------|-----------:|----------------:|--------------:|-------------------:|----------------:|---------------------:|
| Spring |      13.80 |            4.18 |         58.20 |              11.15 |           17.54 |                 5.81 |
| Summer |      21.51 |            5.31 |         60.57 |              14.75 |           13.17 |                 3.28 |
| Fall   |      29.28 |            3.46 |         61.68 |              11.62 |           10.21 |                 3.04 |
| Winter |      17.70 |            4.65 |         61.56 |              10.96 |           12.60 |                 3.71 |
...
![](./Reports/Friday_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
|:-------|-------------------:|------------------------:|
| Spring |            2932.88 |                 1084.76 |
| Summer |            5060.19 |                 2200.93 |
| Fall   |            5808.55 |                 1490.13 |
| Winter |            5223.78 |                 1537.89 |
...
![](./Reports/Friday_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](./Reports/Friday_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
Thus, our model for the distribution of bike rentals in a day for Friday
is:
