...
Tuesday) will act as the response, which makes more sense for bike
...
-   read in the data and subset for Tuesdays and split into training and
    testings sets
...
and subset for all the Tuesdays in the data set.
...
rentals in a day for all the Tuesdays in the data to get an idea of the
distribution.
...
![](Reports/Tuesday_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
|:-------|-----------:|----------------:|--------------:|-------------------:|----------------:|---------------------:|
| Spring |      12.06 |            4.03 |         57.14 |              15.23 |           13.93 |                 5.23 |
| Summer |      24.02 |            5.09 |         62.77 |              14.54 |           16.37 |                 5.28 |
| Fall   |      29.28 |            2.63 |         61.94 |              10.66 |           11.16 |                 4.15 |
| Winter |      18.59 |            4.22 |         69.76 |              10.35 |           11.22 |                 4.51 |
...
![](Reports/Tuesday_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
|:-------|-------------------:|------------------------:|
| Spring |            2866.60 |                 1415.69 |
| Summer |            4562.94 |                 1543.49 |
| Fall   |            5743.19 |                 1216.85 |
| Winter |            4940.50 |                 1646.43 |
...
![](Reports/Tuesday_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Reports/Tuesday_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
|                    |   RMSE | Rsquared |    MAE |
|:-------------------|-------:|---------:|-------:|
| OLS                | 757.79 |     0.83 | 600.23 |
| Poisson Regression | 644.74 |     0.87 | 501.72 |
| Random Forest      | 837.04 |     0.79 | 648.86 |
| Boosted Trees      | 653.82 |     0.87 | 502.69 |

Table 3: Repeated k-folds CV Performance Summary

The best performing model in repeated k-folds CV is the Poisson
Regression with an RMSE of 644.74. Usually, we would pick the best
...
|                    |   RMSE | Rsquared |    MAE |
|:-------------------|-------:|---------:|-------:|
| OLS                | 845.71 |     0.84 | 681.96 |
| Poisson Regression | 751.89 |     0.86 | 609.47 |
| Random Forest      | 948.53 |     0.76 | 730.53 |
| Boosted Trees      | 823.44 |     0.82 | 638.08 |

Table 4: Test Set Performance Summary

The best performing model on the testing set is the Poisson Regression
with an RMSE of 751.89.
